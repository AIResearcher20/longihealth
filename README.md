...
[![Tests](https://img.shields.io/badge/tests-11_passed-22C55E?logo=pytest&logoColor=white)](tests/)
...
The project is a research software engineering (RSE) deliverable, not a
clinical prediction system. Its central research-software question is:
...
Because this is the MIMIC-IV demonstration dataset, the cohort is
intentionally small and is used for methodological and software-engineering
demonstration rather than clinical validation.

Raw MIMIC-IV data are not redistributed with this repository. Users must
obtain them through PhysioNet and comply with the applicable data-use terms.
...
The final admission-level matrix contained 128 admissions × 386 clinical
features, with an overall feature missingness of approximately 40.62% before
final preprocessing.
...
This matters because individual patients can contribute multiple hospital
...
These results should not be interpreted as evidence of clinical predictive
performance.
...
The purpose of this project is consequently not to claim a clinically useful
mortality predictor, but to demonstrate a reproducible analytical framework
capable of handling longitudinal clinical data while explicitly exposing its
